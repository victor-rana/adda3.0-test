...
import women.fashion.compare.clothes.shop.womenshopping.offers.di.component.DaggerViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as women.fashion.compare.clothes.shop.womenshopping.offers.MainApplication).applicationComponent)
